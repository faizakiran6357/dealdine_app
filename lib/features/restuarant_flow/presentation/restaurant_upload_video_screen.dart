...
// class RestaurantUploadVideoScreen extends StatelessWidget {
...
//         children: [
//           // ---------------- LEFT SIDEBAR ----------------
//           LeftSidebar(width: isWeb ? 240 : 70, showLabels: isWeb),
...
// import 'dart:html' as html; // for web blob
...
//       setState(() {
//         uploadedVideos.add(LocalVideoData(
//           file: file,
...
//                   topLeft: Radius.circular(12),
//                   topRight: Radius.circular(12)),
//               child: VideoPlayerWidgetWeb(bytes: video.bytes),
//             ),
//             const SizedBox(height: 10),
//             Padding(
...
//               child: Text(
//                 "Just Uploaded",
//                 style: TextStyle(color: Color(0xFF6B7180), fontSize: 12),
//               ),
//             ),
//           ],
//         ),
...
//                                             size: 40, color: Color(0xFF6B7180)),
//                                         SizedBox(height: 10),
//                                         Text(
//                                           "Drag and drop your video here, or click to browse",
//                                           style: TextStyle(
...
//                               ),
//                               itemBuilder: (context, index) =>
//                                   buildVideoItem(uploadedVideos[index]),
//                             );
//                           },
//                         ),
//                         const SizedBox(height: 50),
...
// // -------------------- WEB VIDEO PLAYER --------------------
// class VideoPlayerWidgetWeb extends StatefulWidget {
//   final Uint8List bytes;

//   const VideoPlayerWidgetWeb({super.key, required this.bytes});

//   @override
//   State<VideoPlayerWidgetWeb> createState() => _VideoPlayerWidgetWebState();
// }

// class _VideoPlayerWidgetWebState extends State<VideoPlayerWidgetWeb> {
...
//     blobUrl = html.Url.createObjectUrlFromBlob(
//       html.Blob([widget.bytes], 'video/mp4'),
//     );
...
//   void dispose() {
//     _controller.dispose();
//     html.Url.revokeObjectUrl(blobUrl); // cleanup
//     super.dispose();
//   }
...
//   Widget buildVideoItem(dynamic video) {
//     if (kIsWeb && video is WebVideoData) {
//       return WebVideoPlayerItem(video: video);
//     } else if (!kIsWeb && video is LocalVideoData) {
//       return MobileVideoPlayerItem(video: video);
//     }
//     return const SizedBox();
//   }
...
//   const WebVideoPlayerItem({super.key, required this.video});
...
//     super.initState();
//     blobUrl = html.Url.createObjectUrlFromBlob(
//       html.Blob([widget.video.bytes], 'video/mp4'),
//     );
//     _controller = VideoPlayerController.network(blobUrl)
//       ..initialize().then((_) {
//         setState(() {});
...
//   const MobileVideoPlayerItem({super.key, required this.video});
...
//             padding: const EdgeInsets.symmetric(horizontal: 10, vertical: 4),
//             child: Text(
//                 widget.video.file.path.split('/').last,
//                 maxLines: 1,
//                 overflow: TextOverflow.ellipsis,
//                 style: const TextStyle(fontWeight: FontWeight.w600)),
//           ),
...
//             allowScrubbing: true, padding: const EdgeInsets.symmetric(horizontal: 10)),
//         Row(
...
//         video: file.path,
//         imageFormat: ImageFormat.PNG,
//         maxHeight: 300, // Bigger thumbnail
//         quality: 75,
//       );
...
// import 'package:dealdine_application/widgets/left_sidebar.dart';
// import 'package:dealdine_application/widgets/top_navbar.dart';
// import 'package:dealdine_application/device/video/video_helper.dart'; // <-- new helper
...
// import 'package:dealdine_application/widgets/left_sidebar.dart';
// import 'package:dealdine_application/widgets/top_navbar.dart';
// import 'package:dealdine_application/device/video/video_helper.dart'; // <-- helper
...
//                 crossAxisAlignment: CrossAxisAlignment.start,
//                 children: [
//                   if (isWeb || isTablet) TopNavBar(isWeb: true),
//                   const SizedBox(height: 20),
//                   const Padding(
//                     padding: EdgeInsets.symmetric(horizontal: 40),
//                     child: Text(
